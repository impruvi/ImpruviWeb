    ...
    return (
        <div className={classes.Container}>
            <div className={classes.Section}>
                <h1>Terms and Conditions of impruviapp.com</h1>
                <div>
                    These Terms govern
                </div>
                <div>
                ...
                <div>
                    Owner contact email: <a href="mailto:ryancrowleysoccer@gmail.com?Subject=Hello%20Impruvi" target="_blank">ryancrowleysoccer@gmail.com</a>
                </div>
            </div>
            ...
            <div className={classes.Section}>
                ...
                <h4>Rights regarding content on this Application - All rights reserved</h4>
                <div>
